# AMLPIC
MetaPhys-DA: Cross-Domain Few-Shot Hyperspectral Image Classification
...
Key Components
Dual-Branch Feature Extractor: SSFTT (Transformer-based) + Mamba (State Space Model)
PINN Module: Physics-informed constraint based on spectral absorption equations
Adaptive Weighting Agent (AWA): Dynamically balances classification and physics losses
Domain Adversarial Alignment: Aligns source and auxiliary domain feature distributions

Layer-wise Gradient Modulation: Stabilizes few-shot parameter updates
