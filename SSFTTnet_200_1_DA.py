...
class SSFTTnet(nn.Module):
    def __init__(self, in_channels=1, num_classes=16, spec_dim=128, num_tokens=4, dim=64, depth=1, heads=8, mlp_dim=8, dropout=0.1, emb_dropout=0.1):
        ...
        conv2d_in = 8 * (spec_dim - 2)
        self.conv2d_features = nn.Sequential(
            nn.Conv2d(in_channels=conv2d_in, out_channels=64, kernel_size=(3, 3)),
            nn.BatchNorm2d(64),
            nn.ReLU(),
        )
